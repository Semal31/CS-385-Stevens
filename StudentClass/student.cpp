 ...
 * Description : Takes in student's info and then gives a list of the students and identifies the failing students
...
void print_students(const vector<Student> &students) {
    for (auto stu = students.cbegin(); stu != students.cend(); stu++) {
        stu->print_info();
    }
}
